...
final class EncryptedAssertionTest extends TestCase
{
    ...
    public function testMarshalling(): void
    {
        ...
        $ek = new EncryptedKey(
            cipherData: new CipherData(
                CipherValue::fromString('sNLWjwyj/R0oPwSgNnqowahiOwM0YU3YaH3jsH0t2YUDcHkcgouvW5x6YbNdgvGq0ImsNrkjI//0hrL4HvrOX33+DkhCo2FX5+a7UCdftfBfSjvt0houF8z3Zq/XOm6HxBUbWt5MULYpMKMZ9iAY6+raydxk2tFWgnAyHaBfzvU='),
            ),
        ...
        $actualXml = strval($encryptedAssertion);
    ...
    public function testEncryption(): void
    {
        $assertion = new Assertion(
            ...
            subject: new Subject(
                new NameID(
                    SAMLStringValue::fromString('Someone'),
                ),
            ),
        );
