...
use SimpleSAMLSAML2\XML\saml\AudienceRestriction;
use SimpleSAMLSAML2\XML\saml\AuthnContextClassRef;
use SimpleSAMLSAML2\XML\saml\Conditions;
use SimpleSAMLSAML2\XML\saml\EncryptedID;
use SimpleSAMLSAML2\XML\saml\Issuer;
use SimpleSAMLSAML2\XML\saml\NameID;
use SimpleSAMLSAML2\XML\saml\ProxyRestriction;
