...
XML
        ...
        $this->assertInstanceOf(SAML2\XML\Chunk::class, $entityAttributes->getChildren()[0]);
        $this->assertInstanceOf(SAML2\XML\saml\Attribute::class, $entityAttributes->getChildren()[1]);
        $this->assertInstanceOf(SAML2\XML\Chunk::class, $entityAttributes->getChildren()[2]);
        $this->assertInstanceOf(SAML2\XML\saml\Attribute::class, $entityAttributes->getChildren()[3]);
        $this->assertInstanceOf(SAML2\XML\saml\Attribute::class, $entityAttributes->getChildren()[4]);
