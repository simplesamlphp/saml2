...
XML;
        ...
        $this->assertEquals(Constants::NAMEFORMAT_URI, $attributes[0]->NameFormat());
        $this->assertEquals(Constants::NAMEFORMAT_URI, $attributes[1]->NameFormat());
        $this->assertEquals(Constants::NAMEFORMAT_URI, $attributes[2]->NameFormat());
    }
