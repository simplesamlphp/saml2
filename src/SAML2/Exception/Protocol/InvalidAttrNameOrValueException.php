 ...
 */
class InvalidAttrNameOrValueException extends AbstractProtocolException
{
    /**
     * InvalidAttrNameOrValueException constructor.
     *
    ...
    {
        parent::__construct($responsible, Constants::STATUS_INVALID_ATTR, $message);
    }
}
