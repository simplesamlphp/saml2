 ...
 */
class UnknownPrincipalException extends AbstractProtocolException
{
    /**
     * UnknownPrincipalException constructor.
     *
    ...
    {
        parent::__construct($responsible, Constants::STATUS_UNKNOWN_PRINCIPAL, $message);
    }
}
