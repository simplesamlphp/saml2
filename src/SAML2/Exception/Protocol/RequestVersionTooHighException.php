 ...
 */
class RequestVersionTooHighException extends AbstractProtocolException
{
    /**
     * RequestVersionTooHighException constructor.
     *
    ...
    {
        parent::__construct($responsible, Constants::STATUS_REQUEST_VERSION_TOO_HIGH, $message);
    }
}
